...

{
    ...
    let currComponent: HTMLElement | null = null;
    ...
    function loadHome(){
        const component = document.createElement("home-component") as HomeComponent;
    ...
    function definirComponente(component: string | HTMLElement, url:string) {
